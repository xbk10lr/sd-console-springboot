...
* 主题样式：开源版 
*/
var _menus_oneLeve=[{"menuid":"0","menuname":"批量管理","icon":"fa-home"},{"menuid":"1","menuname":"订单管理","icon":"fa-trophy"},{"menuid":"2","menuname":"测试模拟","icon":"fa-inbox"}/*,{"menuid":"3","menuname":"文档帮助","icon":"fa-suitcase"},{"menuid":"4","menuname":"系统管理","icon":"fa-dropbox"}*/];
var _menus=[
